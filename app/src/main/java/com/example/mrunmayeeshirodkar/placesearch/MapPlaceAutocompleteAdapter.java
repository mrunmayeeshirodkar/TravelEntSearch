...
public class MapPlaceAutocompleteAdapter
    ...
    private static final String TAG = "MapPlaceAutocompleteAdapter";
     ...
     */
    public MapPlaceAutocompleteAdapter(Context context, GeoDataClient geoDataClient,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position != (mResultList.size() - 1)) {
            ...
            params.height = 150;
            textView2.setLayoutParams(params);
            textView2.setPadding(400,20,0,50);
